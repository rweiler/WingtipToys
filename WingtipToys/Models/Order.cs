...
namespace WingtipToys.Models {
	public class Order {
		...
		[Required(ErrorMessage = "First Name is required"), Display(Name = "First Name"), StringLength(160)]
		public string FirstName { get; set; }

		[Required(ErrorMessage = "Last Name is required"), Display(Name = "Last Name"), StringLength(160)]
		...
		[Required(ErrorMessage = "Postal Code is required"), Display(Name = "Postal Code"), StringLength(10)]
